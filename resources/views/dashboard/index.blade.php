    ...
    <div class="row g-4">
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body">
                    <div
                        style="padding:16px 20px; border-bottom:1px solid var(--color-rule); display:flex; align-items:center; justify-content:space-between;">
                    ...
                    <div style="flex:1;">
                        ...
                        @else
                            @foreach($recentTransactions as $transaction)
                                <div
                                    style="padding:10px 20px; border-bottom:1px solid var(--color-rule); display:flex; justify-content:space-between; align-items:center;">
                                    <div>
                                        <div style="font-weight:600; font-size:0.8125rem; color:var(--color-ink);">
                                            {{ $transaction->nomor_transaksi }}</div>
                                        <div style="font-size:0.7rem; color:var(--color-muted); margin-top:1px;">
                                            {{ $transaction->user->name }} · {{ $transaction->created_at->format('H:i') }}</div>
                                    </div>
                                    <div style="font-weight:600; font-size:0.8125rem; color:var(--color-ink);">Rp
